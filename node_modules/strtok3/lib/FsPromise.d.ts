...
export declare function writeFile(path: fs.PathLike, data: Uint8Array | string, options?: fs.WriteFileOptions): Promise<void>;
export declare function writeFileSync(path: fs.PathLike, data: Uint8Array | string): void;
export declare function readFile(path: fs.PathLike): Promise<Uint8Array>;
