let handler = m => m; 
 ...
   let responses; 
   if (/^بحبك| عاوزه اتجوزك|يميرزا بحبك|بموت فيك|نتجوز|ميرزا هنتجوز امتي| انت ليا| بموت فيك$/i.test(m.text)) { 
     responses = [ 
       'شكرا  ',  
       'هفكر في الموضوع',  
             'و انا',  
 ...
     ]; 
   }else if (/^ ميرزا عامل ايه|عامله ايه|عاملين ايه|الدنيا عامله ايه|عاملين ايه يشباب$/i.test(m.text)) { 
     responses = [ 
 ...
   }else if (/|ميرزا|بوت|يا$اسكت$/i.test(m.text)) { 
     responses = [ 
       'اي يقلب ميرزا 😍',  
          ' قلب ميرزا😍',  
              'روح ميرزا 😍',  
