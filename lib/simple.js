...
END:VCARD
        ...
        sendButton: {
    /**
     * Enviar un mensaje con botones y multimedia
     * @param {String} jid ID del receptor
     * @param {String} text Texto principal del mensaje
     * @param {String} footer Texto de pie de página
     * @param {Buffer | String} buffer Archivo adjunto (imagen, video, etc.)
     * @param {String[][]} buttons Lista de botones (cada botón como [displayText, buttonId])
     * @param {import('@whiskeysockets/baileys').proto.WebMessageInfo} quoted Mensaje al que responde (opcional)
    ...
    async value(jid, text = '', footer = '', buffer, buttons, quoted, options) {
        ...
        if (!options) options = {};
        let preparedButtons = buttons.map(btn => ({
        ...
        let message = {
            ...
            headerType: 4, // Tipo de encabezado: multimedia
            viewOnce: true,
            ...options,
            ...(buffer ? {
